...
@define('JQUERY_URI', '//code.jquery.com/jquery-3.5.0.min.js');
...
//     echo $this->getKey();
  ...
  */
  ...
  /** Arxiv are a special kind of links, where the url depends on the arxiv */
  function getArxivLink($iconurl=NULL) {
    $str = $this->getIconOrTxt('arxiv',$iconurl);
    if ($this->hasField('arxivid')) {
        return '<a'.get_target().' href="https://arxiv.org/abs/'.$this->getField('arxivid').'">'.$str.'</a>';
    }
    return '';
  }
