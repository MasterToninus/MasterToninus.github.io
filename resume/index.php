...
<link rel="icon" href="../img/favicon.ico" type="image/x-icon">  
  ...
  <!-- -->
  <head>
    <title>Resume | Antonio Michele Miti</title>
    <meta charset="utf-8">
    ...
    <div id="content">
      <div id="content-container">
        ...
        <div id="introduction">
          <div id="desc">   
            <p class="lead">
              Autogenerated list of my scientific activities. 
              Last update: <?php echo date("F Y .",filemtime("../data/activities.csv")); ?></b>
              <br>
              (
                <a href="https://www.dropbox.com/scl/fi/w6l4vkwenl8780v0kewal/cv.pdf?rlkey=dggzb4t7h76nsqts71qt80oyi&st=kvtie7my&e=1&dl=0"
                  class="btn btn-default btn-lg"
                  target="_blank"
                  rel="noopener">
                  <i class="fa fa-file-pdf-o fa-fw"></i>
                  <span class="network-name">PDF CV</span>
                </a>
              |
              <a href="../data"
                class="btn btn-default btn-lg"
                ...
                <span class="network-name">Raw Data</span>
              </a>
            )
            <br>
            </p>          
